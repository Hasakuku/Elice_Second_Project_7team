...
router.post('/', checkUser, checkAdmin, validateBar, uploadImage, imageHandler, barController.createBar);
router.put('/:id', checkUser, checkAdmin, validateBar, uploadImage, imageHandler, barController.updateBar);
