...
router.post('/', checkUser, checkAdmin, validateCocktail, uploadImage, imageHandler, cocktailController.createCocktail); // 칵테일 등록
router.put('/:id', checkUser, checkAdmin, validateCocktail, uploadImage, imageHandler, cocktailController.updateCocktail); // 칵테일 수정
